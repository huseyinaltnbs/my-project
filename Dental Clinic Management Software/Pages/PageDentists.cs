...
namespace Dental_Clinic_Management_Software.Pages
{
    public partial class PageDentists : UserControl
    {
        public PageDentists()
        {
            ...
            grid.OnDelete<Dentist>((a,b) => Kimtoo.DbManager.Connections.GetConnection().Delete(a)>= 0);
        }
        ...
        private void LoadData()
        {
            try
            {
                ...
                List<Dentist> data = db.Select<Dentist>();
                grid.Bind(data);
            }
            catch (Exception ex)
            {
                ...
                List<Dentist> fallbackData = new List<Dentist>();
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            bindingProvider1.Bind(new Dentist());
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            var db = Kimtoo.DbManager.Connections.GetConnection();
            db.Save(bindingProvider1.Get<Dentist>());
            LoadData();
            pnlDrawwer.Visible = false;
        ...
        private void grid_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    pnlDrawwer.Visible = true; 
                    bindingProvider1.Bind(grid.GetRecord<Dentist>());
                }
                if (e.ColumnIndex == colDel.Index)
                    grid.DeleteRow<Dentist>();// Kimtoo Toolkit Feature
            }
            catch (Exception)
            {
